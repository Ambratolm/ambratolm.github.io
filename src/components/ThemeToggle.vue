...
const modeTitle = computed(() => `${darkStore.value} Mode`);
const modeIcon = computed(() =>
  darkStore.isDark ? props.modeIcons.light : props.modeIcons.dark,
);

const themeStore = useThemeStore();
const themeTitle = computed(() => `${themeStore.mode} Theme`);
...
<template>
  <div class="btn-group" role="group" aria-label="Theme Settings Group">
    <a
      ...
      v-bs-tooltip="{
        title: $filters.capitalCase(modeTitle),
        placement: 'bottom',
      }"
      href="#"
    ...
    <a
      v-bs-tooltip="{
        title: $filters.capitalCase(themeTitle),
        placement: 'bottom',
      }"
      href="#"
